...
clay_color_to_rl_color :: proc(color : Color) -> rl.Color {
...
clay_raylib_render :: proc(
	render_commands : ^ClayArray(RenderCommand),
	allocator := context.temp_allocator,
) {
	for i in 0 ..< render_commands.length {
		render_command := RenderCommandArray_Get(render_commands, i)
...
@(private = "file")
draw_rect_rounded :: proc(x, y, w, h : f32, radius : f32, color : Color) {
